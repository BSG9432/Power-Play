...
@Autonomous(name="MQ")
public class MiddleQuestion extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        encoderDriveStrafe(DRIVE_SPEED,-3,-3,3);
        // drive to medium pole
        encoderDrive(DRIVE_SPEED,-24, 24, 3);
        // Strafes left to score 1st cone.
        encoderDriveStrafe(DRIVE_SPEED,12.5,12.5,4);
        // Lifts 33 inches to score
        liftEncoderDrive(DRIVE_SPEED, -50, 5.0);
