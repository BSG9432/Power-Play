...
*/
        ...
        encoderDrive(DRIVE_SPEED, 2.5, 2.5, 5);
        ...
        encoderDrive(DRIVE_SPEED, 21.5, -21.5, 1);
        liftEncoderDrive(DRIVE_SPEED, -18, 1);
        encoderDrive(DRIVE_SPEED, 18.5, 18.5, 1);
        claw1.setPower(.5);
        claw2.setPower(-.4);
        sleep(1000);
        liftEncoderDrive(DRIVE_SPEED, -15,1);
        encoderDrive(DRIVE_SPEED, -22, -22, 4.0);
        encoderDriveStrafe(DRIVE_SPEED, 11.5, -11.5, 2.0);
